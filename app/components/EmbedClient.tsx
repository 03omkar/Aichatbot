...
function EmbedClient({ownerId}:{ownerId:string}){
    ...
    return(
        <div className="mih-h-screen bg-zinc-50 text-zinc-900" >
            <div className="sticky top-0 z-40 bg-white border-b border-zinc-200" >
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <button className="px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100" onClick={()=>navigate.push('/dashboard')}>Back to DashBoard</button>
            ...
            className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-10">
                ...
                <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10">
                    ...
                    <button className="absolute top-3 right-3 bg-white text-zinc-900 text-xs font-mediumn px-3 py-1.5  rounded-lg hover:bg-zinc-200 transition" onClick={copyCode}>
                        {copied?"Copied":"copy" }
                    </button>
                </div>
                <ol className="space-y-3 text-sm tet-zinc-600 list-decimal list-inside">
                    <li>Copy the Emebed Script Code</li>
                    <li>Paste It before the closing Body tag</li>
                    <li>After its done Reaload your website</li>
                </ol>
                <div className="mt-14">
                    <h1 className="text-lg font-medium mmb-2">Live Preview</h1>
            ...
            transition={{repeat:Infinity,duration:3}}
                            className="absolute bottom-6 right-6 w-14 h-14 rounded-full bg-black text-white flex items-center justify-center shadow-2xl cursor-pointer">🗨️</motion.div>
                            </div>
