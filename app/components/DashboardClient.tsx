    ...
    return(
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            ...
            <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                ...
                border-zinc-300 text-sm hover:bg-zinc-100 transition'onClick={()=>navigate.push("/embed")}>Embed ChatBot</button>
                ...
                <motion.div className='w-full max-w-3xl bg-white rounded-2xl shadow-xl p-10'>
                    ...
                    <div className='mb-10'>
                        ...
                        <div className='space-y-4'>
                            <input type="text" className='w-full rounded-xl border order-zinc-300 px-4 py-3 text-sm 
                    ...
                    <div className='mb-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            focus:outline-none focus:ring-2 focus:ring-black/80' placeholder={`Example:
                                ...
                                Delivery Timeframe: 3-5 working days
                                Cash On devliery : Available
